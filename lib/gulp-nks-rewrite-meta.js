(function() {
  ...
  _rewriteMeta = function(file, obj) {
    var bldr, chunkLength, meta, originalKeys, rewriteKeys, shouldInsertModes, shouldInsertTypes, src;
    obj = _validate(obj);
    src = file.isBuffer() ? file.contents : file.path;
    ...
    reader(src, $.formType).read(function(id, data) {
      ...
      if (id === $.chunkId) {
        ...
        chunkParser(data).parse(function(key, value, buf) {
          ...
          if (shuldInsertTypes && key === 'name') {
            chunk.pushKeyValue('types', obj.types);
            return meta.types = obj.types;
          }
        });
